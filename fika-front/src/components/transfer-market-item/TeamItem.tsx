    ...
    <nav className=" flex justify-center">
      <div className="mx-auto" style={{display: 'grid', gap:'10px'}}>
        {teamInfo.map((item, idx) => {
          return (
            <div key={idx}>
              <div style={{display: 'flex', alignItems: 'center', gap:'20px', width:'1328px', height: '109px', backgroundColor:'#1C1E28', borderRadius: '8px', padding: '20px 0 20px 20px'}}>
                ...
                <div className="text-xl text-white" style={{ width: '54px', textAlign: 'center', fontWeight: '500'}}>{item.rank}</div>
                ...
                <div style={{ width: '239px', maxWidth: '239px', height:'69px', backgroundColor: '#262937', borderRadius: '8px'}}></div>
                ...
                <div className="bg-light-gray-text-color" style={{ height: '109px', width: '40px', display: 'flex', justifyContent: 'center', alignItems: 'center', borderBottomRightRadius: '8px', borderTopRightRadius: '8px'}}>
                  <ArrowRight/>
                </div>
              </div>
            </div>
